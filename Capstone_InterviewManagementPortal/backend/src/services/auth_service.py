"""
Authentication Service: User authentication, Password verification, Password reset
                        Role validation and Status validation
"""
...
def reset_password(email: str, current_password: str, new_password: str) -> None:
    """
    Reset user password.
    Args:
    ...
    user_repository.update_password_by_email(email, encoded_password)
